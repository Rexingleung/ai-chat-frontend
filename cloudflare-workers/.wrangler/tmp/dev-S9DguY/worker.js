...
// .wrangler/tmp/bundle-dUycJU/checked-fetch.js
...
// ../../../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/templates/modules-watch-stub.js
...
// .wrangler/tmp/bundle-dUycJU/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-dUycJU/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
function rewireTypes(originalTypeMap, directives) {
  ...
  function rewireNamedType(type) {
    if (isObjectType(type)) {
      ...
      const newConfig = {
        ...config,
        fields: /* @__PURE__ */ __name(() => rewireFields(config.fields), "fields"),
        interfaces: /* @__PURE__ */ __name(() => rewireNamedTypes(config.interfaces), "interfaces")
      };
      ...
      const newConfig = {
        ...config,
        types: /* @__PURE__ */ __name(() => rewireNamedTypes(config.types), "types")
      };
      ...
      const newConfig = {
        ...config,
        fields: /* @__PURE__ */ __name(() => rewireInputFields(config.fields), "fields")
      };
...
var collectSubFields = memoize5(/* @__PURE__ */ __name(function collectSubfields(schema, fragments, variableValues, returnType, fieldNodes) {
...
function addResolversToSchema({ schema, resolvers: inputResolvers, defaultFieldResolver: defaultFieldResolver3, resolverValidationOptions = {}, inheritResolversFromInterfaces = false, updateResolversInPlace = false }) {
  ...
  schema = updateResolversInPlace ? addResolversToExistingSchema(schema, resolvers2, defaultFieldResolver3) : createNewSchemaWithResolvers(schema, resolvers2, defaultFieldResolver3);
...
function addResolversToExistingSchema(schema, resolvers2, defaultFieldResolver3) {
  const typeMap = schema.getTypeMap();
  for (const typeName in resolvers2) {
    const type = schema.getType(typeName);
    const resolverValue = resolvers2[typeName];
...
function createNewSchemaWithResolvers(schema, resolvers2, defaultFieldResolver3) {
...
var executorFromSchema = memoize1(/* @__PURE__ */ __name(function executorFromSchema2(schema) {
...
var CustomAbortControllerSignal = class extends EventTarget {
  static {
    __name(this, "CustomAbortControllerSignal");
  }
  aborted = false;
  _onabort = null;
  _reason;
...
var YogaServer = class {
  ...
  constructor(options) {
    ...
    this.maskedErrorsOpts = options?.maskedErrors === false ? null : {
      ...
      maskError: /* @__PURE__ */ __name((error, message) => {
  ...
  handleParams = /* @__PURE__ */ __name(({ request, context, params }) => {
  ...
  getResultForParams = /* @__PURE__ */ __name(({ params, request }, context) => {
    let result;
...
var resolvers = {
  Query: {
    health: /* @__PURE__ */ __name(async (parent, args, context) => {
      const { env } = context;
      const services = {
    ...
    conversation: /* @__PURE__ */ __name(async (parent, { id }, context) => {
      const { env } = context;
      try {
        ...
        return {
          id,
          messages,
          createdAt: messages[0]?.timestamp || (/* @__PURE__ */ new Date()).toISOString(),
          updatedAt: messages[messages.length - 1]?.timestamp || (/* @__PURE__ */ new Date()).toISOString(),
  ...
  Mutation: {
    createConversation: /* @__PURE__ */ __name(async (parent, args, context) => {
      try {
    ...
    sendMessage: /* @__PURE__ */ __name(async (parent, { input }, context) => {
    ...
    clearConversation: /* @__PURE__ */ __name(async (parent, { id }, context) => {
      const { env } = context;
      try {
...
async function callDeepSeekAPI(env, { message, history, model = "deepseek-chat", temperature = 0.7, maxTokens = 1e3 }) {
...
__name(getConversationMessages, "getConversationMessages");
...
__name(clearConversationMessages, "clearConversationMessages");
...
function validateMessageInput(input) {
  ...
  if (input.maxTokens && (input.maxTokens < 1 || input.maxTokens > 4e3)) {
    return { valid: false, error: "\u6700\u5927token\u6570\u5FC5\u987B\u57281-4000\u4E4B\u95F4" };
  }
  return { valid: true };
}
__name(validateMessageInput, "validateMessageInput");
...
__name(checkDeepSeekStatus, "checkDeepSeekStatus");
...
__name(checkDatabaseStatus, "checkDatabaseStatus");
...
var yoga = createYoga({
  ...
  graphiql: true,
  // 启用 GraphiQL 界面
  context: /* @__PURE__ */ __name(({ request, env }) => ({ request, env }), "context")
});
var worker_default = {
